...
AUTH_API_LOGIN_URL = os.getenv(
    'AUTH_API_LOGIN_URL', 'http://authapi:8000/authapi/api/v1/jwt/login'
)
AUTH_API_PROFILE_URL = os.getenv(
    'AUTH_API_PROFILE_URL', 'http://authapi:8000/authapi/api/v1/users/profile'
)
